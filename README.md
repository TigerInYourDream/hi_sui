# hi_sui
学习 sui_move的记录 每个文件夹中都是一个 sui_move的项目。下面是一些 tips:

### 学习资源

1. https://www.bilibili.com/video/BV1RY411v7YU?p=11&spm_id_from=pageDriver&vd_source=35f6a091ca26066f38298d5d9b0e5c85
2. https://intro-zh.sui-book.com/unit-two/lessons/3_参数传递与删除 Object.htm
3. https://docs.sui.io/guides

以上链接是 Builder_DAO的视频课程和move导论的中文版。开始看这个视频或者直接看书就足够了

第三个链接是 sui 官方 doc.是更全面的材料
