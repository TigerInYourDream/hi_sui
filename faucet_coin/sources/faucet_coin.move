module faucet_coin::faucet_coin {
    ...
    fun init(waitness: FAUCET_COIN, ctx: &mut sui::tx_context::TxContext) {
        let (treasury_cap, meta) = coin::create_currency(waitness,2,b"FAUCET_COIN", b"FC$", b"", option::none(), ctx);
    ...
    public entry fun burn(
        treasury_cap: &mut TreasuryCap<FAUCET_COIN>, coin : Coin<FAUCET_COIN>, _ctx: &mut TxContext
    ) {
